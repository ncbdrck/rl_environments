...
class VX300SPushEnv(vx300s_robot_real.VX300SRobotEnv):
    """
    This Task env is for a simple push Task with the VX300S robot.
    ...
    def __init__(self, new_roscore: bool = False, roscore_port: str = None,
        ...
        if ros_port is not None:
            self.node_name = "VX300SPushEnvReal" + "_" + ros_port
        else:
            self.node_name = "VX300SPushEnvReal"
