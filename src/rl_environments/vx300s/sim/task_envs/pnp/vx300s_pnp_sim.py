...
# Custom robot env
from rl_environments.vx300s.sim.robot_envs import vx300s_robot_sim
...
class VX300SPnPEnv(vx300s_robot_sim.VX300SRobotEnv):
    """
    ...
    def __init__(self, launch_gazebo: bool = True, new_roscore: bool = True, roscore_port: str = None,
        ...
        if ros_port is not None:
            self.node_name = "VX300SPnPEnv" + "_" + ros_port
        else:
            self.node_name = "VX300SPnPEnv"
