...
class UR5ePushGoalEnv(ur5e_robot_goal_real.UR5eRobotGoalEnv):
    """
    ...
    def __init__(self, new_roscore: bool = False, roscore_port: str = None,
        ...
        if ros_port is not None:
            self.node_name = "UR5ePushGoalEnvReal" + "_" + ros_port
        else:
            self.node_name = "UR5ePushGoalEnvReal"
        ...
        if auto_launch_cube_tracker:
            ...
            # Optional second adapter for a "goal" AprilTag on the desk —
            # shared apriltag_ros + TF chain, one extra adapter node.
            if goal_pose_topic:
