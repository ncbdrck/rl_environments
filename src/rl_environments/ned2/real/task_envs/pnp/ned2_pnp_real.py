...
class NED2PnPEnv(ned2_robot_real.NED2RobotEnv):
    ...
    def __init__(self, new_roscore: bool = False, roscore_port: str = None,
        ...
        if ros_port is not None:
            self.node_name = "NED2PnPEnvReal" + "_" + ros_port
        else:
            self.node_name = "NED2PnPEnvReal"
        ...
        # so the action space matches RX200 PnP — the discretization
    ...
    def _set_init_params(self, options: Optional[Dict[str, Any]] = None):
        ...
        # point.
        if self.multi_goal:
            cube_xyz = cube_init_vector.copy()
