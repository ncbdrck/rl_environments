...
class UR5eReacherGoalEnv(ur5e_robot_goal_sim.UR5eRobotGoalEnv):
    """
    ...
    def __init__(self, launch_gazebo: bool = True, new_roscore: bool = True, roscore_port: str = None,
                 gazebo_paused: bool = True, gazebo_gui: bool = False, seed: int = None, reward_type: str = "sparse",
                 ...
                 load_table: bool = True, load_cube: bool = False, debug: bool = False, log_internal_state: bool = False,
        ...
        if ros_port is not None:
            self.node_name = "UR5eReacherGoalEnvSim" + "_" + ros_port
        else:
            self.node_name = "UR5eReacherGoalEnvSim"
        ...
        ros_common.ros_load_yaml(pkg_name="rl_environments", file_name="ur5e_reach_task_config.yaml", ns="/")
        self._get_params()
        ...
        # UR5eRobotEnv maps real_time → unpause_pause_physics (False when real_time,
        # True otherwise). One kwarg drives both step modes.
    ...
    def execute_action(self, action):
        ...
        # --- Joint action
            ...
            if self.delta_action:
                ...
                # Refresh joint_values inline so the delta is computed against
            ...
            if self.check_action_within_workspace(action):
                ...
                # was refreshed at the top of this delta-action block, so the
                # delta-clip uses live state. hasattr guard for the same
                # reason as the EE branch.
                if hasattr(self, "_check_action_links_safe"):
                    safe, reason = self._check_action_links_safe(
