...
# Custom robot env
from rl_environments.vx300s.real.robot_envs import vx300s_robot_goal_real
...
# register(
#     id='VX300SPushSim-v1',
#     entry_point='rl_environments.vx300s.sim.task_envs.push.vx300s_kinect_push_sim_v1:VX300SPushGoalEnv',
...
class VX300SPnPGoalEnv(vx300s_robot_goal_real.VX300SRobotGoalEnv):
    """
    ...
    def __init__(self, new_roscore: bool = False, roscore_port: str = None,
        ...
        if ros_port is not None:
            self.node_name = "VX300SPnPGoalEnvReal" + "_" + ros_port
        else:
            self.node_name = "VX300SPnPGoalEnvReal"
