...
"""
register(
    id='RX200RobotGoalEnv_zed2-v0',
    entry_point='rl_environments.rx200.sim.robot_envs.rx200_robot_goal_sim_zed2:RX200RobotGoalEnv',
...
class RX200RobotGoalEnv(GazeboGoalEnv.GazeboGoalEnv):
    ...
    def __init__(self, ros_port: str = None, gazebo_port: str = None, gazebo_pid=None, seed: int = None,
        ...
        Sensor Topic List:
            ...
            /rx200/zed2/depth/depth_registered: Depth image from the ZED2 camera
            /rx200/zed2/left/image_rect_color: RGB image from the ZED2 camera
