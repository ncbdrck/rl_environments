...
"""
This is the v0 of the VX300S Reacher Task Environment made for the real robot.
...
class VX300SReacherEnv(vx300s_robot_real.VX300SRobotEnv):
    """
    ...
    def __init__(self, new_roscore: bool = False, roscore_port: str = None, seed: int = None,
        ...
        if ros_port is not None:
            self.node_name = "VX300SReacherEnvReal" + "_" + ros_port
        else:
            self.node_name = "VX300SReacherEnvReal"
