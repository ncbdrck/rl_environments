...
"""
NED2 Push Task Environment (sim).

Ported from the RX200 kinect push sim env (rx200_kinect_push_sim.py) with
...
class NED2PushEnv(ned2_robot_sim.NED2RobotEnv):
    """
    ...
    def __init__(self, launch_gazebo: bool = True, new_roscore: bool = True, roscore_port: str = None,
        ...
        if ros_port is not None:
            self.node_name = "NED2PushEnv" + "_" + ros_port
        else:
            self.node_name = "NED2PushEnv"
