...
class UR5ePushEnv(ur5e_robot_real.UR5eRobotEnv):
    """
    This Task env is for a simple push Task with the UR5e robot.
    ...
    def __init__(self, new_roscore: bool = False, roscore_port: str = None,
        ...
        if ros_port is not None:
            self.node_name = "UR5ePushEnvReal" + "_" + ros_port
        else:
            self.node_name = "UR5ePushEnvReal"
        ...
        ros_common.ros_load_yaml(pkg_name="rl_environments", file_name="ur5e_push_task_config.yaml", ns="/")
        self._get_params()
    ...
    def _set_init_params(self, options: Optional[Dict[str, Any]] = None):
        ...
        self.movement_result = self.move_gripper_joints(self.init_close_gripper)
