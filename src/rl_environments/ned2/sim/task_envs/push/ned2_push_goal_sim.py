...
class NED2PushGoalEnv(ned2_robot_goal_sim.NED2RobotGoalEnv):
    ...
    def __init__(self, launch_gazebo: bool = True, new_roscore: bool = True, roscore_port: str = None,
        ...
        if ros_port is not None:
            self.node_name = "NED2PushGoalEnv" + "_" + ros_port
        else:
            self.node_name = "NED2PushGoalEnv"
        ...
        super().__init__(ros_port=ros_port, gazebo_port=gazebo_port, gazebo_pid=gazebo_pid, seed=seed,
                         real_time=self.realtime_mode, action_cycle_time=action_cycle_time, use_camera=use_camera,
    ...
    def _set_init_params(self, options: Optional[Dict[str, Any]] = None):
        ...
        # if we don't spwan cube randomly, we can hard code one
            ...
            # TODO: confirm NED2 push static cube spawn pose
        ...
        # has something to return before the first sample_observation tick.
    ...
    def _launch_gazebo(self, launch_roscore=True, port=None, paused=False, use_sim_time=True,
        ...
        """
        # TODO: confirm NED2 push world file. ned2_reach uses
        ...
        # RX200 push template — the train script can override
