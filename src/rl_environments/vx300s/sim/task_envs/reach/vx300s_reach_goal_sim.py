...
"""
This is the v0 of the VX300S Reacher Goal conditioned Task Environment.
...
class VX300SReacherGoalEnv(vx300s_robot_goal_sim.VX300SRobotGoalEnv):
    """
    ...
    def __init__(self, launch_gazebo: bool = True, new_roscore: bool = True, roscore_port: str = None,
        ...
        if ros_port is not None:
            self.node_name = "VX300SReacherGoalEnvSim" + "_" + ros_port
        else:
            self.node_name = "VX300SReacherGoalEnvSim"
        ...
        Init super class.
        """
        # VX300SRobotEnv maps real_time → unpause_pause_physics (False when real_time,
