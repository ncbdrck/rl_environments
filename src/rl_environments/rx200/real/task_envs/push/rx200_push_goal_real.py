...
# Custom robot env
from rl_environments.rx200.real.robot_envs import rx200_robot_goal_real
...
# register(
#     id='RX200PushSim-v1',
#     entry_point='rl_environments.rx200.sim.task_envs.push.rx200_kinect_push_sim_v1:RX200PushGoalEnv',
#     max_episode_steps=1000,
# )


class RX200PushGoalEnv(rx200_robot_goal_real.RX200RobotGoalEnv):
    """
    This Task env is for a simple push Task with the RX200 robot.
    ...
    def __init__(self, new_roscore: bool = False, roscore_port: str = None,
        ...
        if ros_port is not None:
            self.node_name = "RX200PushGoalEnvReal" + "_" + ros_port
        else:
            self.node_name = "RX200PushGoalEnvReal"
        ...
        ros_common.ros_load_yaml(pkg_name="rl_environments", file_name="rx200_push_task_config.yaml", ns="/")
        self._get_params()
