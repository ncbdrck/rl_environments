...
class NED2PnPEnv(ned2_robot_sim.NED2RobotEnv):
    ...
    def __init__(self, launch_gazebo: bool = True, new_roscore: bool = True, roscore_port: str = None,
        ...
        if ros_port is not None:
            self.node_name = "NED2PnPEnv" + "_" + ros_port
        else:
            self.node_name = "NED2PnPEnv"
    ...
    def sample_observation(self):
        ...
        # --- Get the current cube position and orientation. The NED2 robot
        # env's get_model_pose defaults to model_name="red_cube".
        ...
        # "closed on something". TODO: empirically calibrate against an
        # actual cube grasp; the stroke is tiny so the threshold matters.
        try:
    ...
    def _launch_gazebo(self, launch_roscore=True, port=None, paused=False, use_sim_time=True,
        ...
        # NED2 push template — the train script can override
