...
class UR5eReacherEnv(ur5e_robot_real.UR5eRobotEnv):
    """
    ...
    def __init__(self, new_roscore: bool = False, roscore_port: str = None, seed: int = None,
        ...
        if ros_port is not None:
            self.node_name = "UR5eReacherEnvReal" + "_" + ros_port
        else:
            self.node_name = "UR5eReacherEnvReal"
        ...
        if self.ee_action_type:
            ...
            if self.workspace_space.contains(action):
                ...
                if IK_found:
                    ...
                    # when the EE target sits above. Reject before publishing
                    # to the real driver — on hardware a single bad target
                    # can ram the arm into the table.
