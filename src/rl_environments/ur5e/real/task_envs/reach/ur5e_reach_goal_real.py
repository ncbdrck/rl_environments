...
class UR5eReacherGoalEnv(ur5e_robot_goal_real.UR5eRobotGoalEnv):
    """
    ...
    def __init__(self, new_roscore: bool = False, roscore_port: str = None, seed: int = None,
                 ...
                 reset_controllers_prompt: bool = False, reward_type: str = "sparse",
        ...
        if ros_port is not None:
            self.node_name = "UR5eReacherGoalEnvReal" + "_" + ros_port
        else:
            self.node_name = "UR5eReacherGoalEnvReal"
